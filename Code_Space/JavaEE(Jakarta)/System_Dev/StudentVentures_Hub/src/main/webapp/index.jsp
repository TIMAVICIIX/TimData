...
<nav class="navbar top-border">
    ...
    <div id="TopLogo&Title">
        ...
        <img class="d-inline-block" src="${pageContext.request.contextPath}/static/resources/index/LXXT_Logo.png"
    ...
    <div class="mx-auto">
        <button id="LoginNavbarBtn" class="Navbar_Choosers">
            登录
            <img class="Navbar_Choose_Sign" src="${pageContext.request.contextPath}/static/resources/index/login.png"
                 alt="Login">
        </button>
        <button id="QueryNavbarBtn" class="Navbar_Choosers">
            查看假期
            <img class="Navbar_Choose_Sign" src="${pageContext.request.contextPath}/static/resources/index/check.png"
                 alt="Check">
        </button>
        <button id="AttendNavbarBtn" class="Navbar_Choosers">
            申请入学
            <img class="Navbar_Choose_Sign" src="${pageContext.request.contextPath}/static/resources/index/submit.png"
                 alt="Submit">
        </button>
    </div>
    ...
    <button id="JoinUs">
        加入我们
        <img src="${pageContext.request.contextPath}/static/resources/index/JoinUs.png" alt="JoinUs">
    </button>
        ...
        <div id="Left_page">
            ...
            <div id="Left_Banner">
                ...
                <div id="BannerContainer">
                    <div id="Banner">
                        ...
                        <div id="banner_attend" class="Banner_Content"
                             style="background-image: url(static/resources/index/Attend.jpg)">
                            <p>申请入学</p>
                        </div>
                        <div id="banner_help" class="Banner_Content"
            ...
            <div id="Inquire&Help">
                ...
                <div id="Inquire&Help_title">
                    <p><img src="${pageContext.request.contextPath}/static/resources/index/inquire.png" alt="inquire"
                            style="margin: 0 15px 5px 20px;width: 25px;height: 25px">帮助&公告</p>
                </div>
                <a class="Inquire&Help_content"
                   href="${pageContext.request.contextPath}/Page_Help&Inquire/20231117_startedannounce.html"
                   target="_blank">
                    <p class="IH_title">关于系统的启动发布公告</p>
                    <p class="IH_date">2023-11-17</p>
                </a>
                <a class="Inquire&Help_content"
                   href="${pageContext.request.contextPath}/Page_Help&Inquire/20231121_help&inquire.html"
                   target="_blank">
    ...
    <div id="Index_Query">
        ...
        <div class="filter_top">
            <div class="filter_area">
                筛选条件:
                <input id="filter_input_mainVentureQuery" class="filter_input" type="text"
                       placeholder="假期名称/日期/学院/年份">
                <button id="filter_submit_mainVentureQuery" class="filter_submit">
                    <img src="${pageContext.request.contextPath}/static/resources/index/filterChose.png"
                         style="width: 25px;height: 25px" alt="submit">
                </button>
                <button id="filter_refresh_mainVentureQuery" class="filter_refresh">
                    刷新
            ...
            <div class="time_recorder">
                上次刷新时间:<p id="refresh_time_mainVentureQuery" class="refresh_time"></p>
            </div>
        </div>
    ...
    <div id="Index_Attend">
        ...
        <div style="width: 100%;height: 560px;display: flex">
            ...
            <div class="attend_Page" id="left_attend_Page">
                <p>我是学生</p>
                <Button id="attend_student_writeInfo">填写申请信息<img
                        src="${pageContext.request.contextPath}/static/resources/index/writedown.png"
                        alt="writeDown"></Button>
                <Button id="attend_student_checkState">查看申请情况<img
                        src="${pageContext.request.contextPath}/static/resources/index/attendcheck.png"
                        alt="Check"></Button>
                <div style="position: relative;width: 100%">
                    <a id="attend_student_transfer" href="#">我想转学<img
                            src="${pageContext.request.contextPath}/static/resources/index/transfer.png"
                            alt="transfer"></a>
                </div>
            </div>
            ...
            <div class="attend_Page" id="right_attend_Page">
                <p>我代表了学院</p>
                <Button id="attend_college_writeInfo">填写申请信息<img
                        src="${pageContext.request.contextPath}/static/resources/index/writedown.png"
                        alt="writeDown"></Button>
                <Button id="attend_college_adopt">认领学院&nbsp;&nbsp;&nbsp;&nbsp;<img
                        src="static/resources/index/attendadopt.png" alt="Adopt">
                </Button>
                <Button id="attend_college_checkState">查看申请情况<img
                        src="${pageContext.request.contextPath}/static/resources/index/attendcheck.png"
                        alt="Check"></Button>
...
<script src="${pageContext.request.contextPath}/static/Js/index/MainBackgroundAnimation.js"></script>
<script src="${pageContext.request.contextPath}/static/Js/index/IndexBannerAnimation.js"></script>
<script src="${pageContext.request.contextPath}/static/Js/index/IndexChangeAnimation.js"></script>
<script src="${pageContext.request.contextPath}/static/Js/index/IndexQueryAnimation.js"></script>
<script src="${pageContext.request.contextPath}/static/Js/index/IndexLoginController.js"></script>
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function queryFilterTable() {
            const filter_var = $('#filter_input_mainVentureQuery').val();
        ...
        function queryStuAndCollegeNum() {

            $.ajax({
                url: "<%=request.getContextPath()%>/index-controller",
                type: "POST",
                data: {
                    action: "stuAndCollegeNum"
                },
                dataType: "text",
                success: function (data) {
                    ...
                    $('#Attend_queryStudent').text(dataList[0]);
                    $('#Attend_queryCollege').text(dataList[1]);
                }
            });
